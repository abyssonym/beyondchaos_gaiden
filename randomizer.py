...
def test():
    ...
    jm.add_junction('edgar', 'junction_critical_haste')
    jm.add_junction('edgar', 'junction_critical_bserk')
    jm.add_junction('edgar', 'junction_critical_float')
    jm.add_junction('edgar', 'junction_critical_vanish')
    #jm.add_junction('edgar', 'junction_critical_warp')
    jm.add_junction('edgar', 'junction_critical_quick')
    jm.add_junction('edgar', 'junction_critical_cure3')
    jm.add_junction('edgar', 'junction_critical_remedy')
    jm.add_junction('edgar', 'junction_critical_regen')
    jm.add_junction('edgar', 'junction_critical_life3')
    jm.add_junction('edgar', 'junction_critical_golem')
    jm.add_junction('edgar', 'junction_critical_fenrir')
    jm.add_junction('edgar', 'junction_critical_rabbit')
    jm.execute()
